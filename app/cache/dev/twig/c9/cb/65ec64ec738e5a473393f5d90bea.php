...
/* AcmeStoreBundle:llibre:LlibreForm.html.twig */
class __TwigTemplate_c9cb65ec64ec738e5a473393f5d90bea extends Twig_Template
{
    ...
    <h1 class=\"title\">";
        // line 10
        echo $this->env->getExtension('translator')->getTranslator()->trans("form_llibre", array(), "messages");
        echo "</h1>
    \t<a href=\"";
        // line 11
    ...
    \t<a href=\"";
        ...
        echo "\" >";
        echo $this->env->getExtension('translator')->getTranslator()->trans("list_book", array(), "messages");
        echo "</a>
...
";
    ...
    {
        return "AcmeStoreBundle:llibre:LlibreForm.html.twig";
    }
