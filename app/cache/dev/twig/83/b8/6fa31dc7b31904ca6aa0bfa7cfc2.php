...
/* AcmeStoreBundle:noticia:NoticiaMain.html.twig */
class __TwigTemplate_83b86fa31dc7b31904ca6aa0bfa7cfc2 extends Twig_Template
{
    ...
    <h1 class=\"title\">";
        // line 10
        echo $this->env->getExtension('translator')->getTranslator()->trans("menu_admin_noticia", array(), "messages");
        echo "</h1>
    ...
    \t<div class=\"inline_menun_interior\" ><a href=\"";
        // line 13
        echo $this->env->getExtension('routing')->getPath("llistat_store_noticia", array("orderBy" => "1=1 order by n.id asc"));
        echo "\" >";
...
";
    ...
    {
        return "AcmeStoreBundle:noticia:NoticiaMain.html.twig";
    }
