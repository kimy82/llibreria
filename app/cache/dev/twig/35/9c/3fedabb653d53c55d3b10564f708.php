...
/* AcmeStoreBundle:llibreria:Noticia.html.twig */
class __TwigTemplate_359c3fedabb653d53c55d3b10564f708 extends Twig_Template
{
...
\t\t\t\t";
        // line 11
        echo $this->env->getExtension('translator')->getTranslator()->trans("f_noticia_title", array(), "messages");
        // line 12
        echo "\t\t\t</div>
\t\t\t
\t\t\t";
...
\t\t\t\t\t\t<p><img id=\"img_";
                // line 25
                echo twig_escape_filter($this->env, $this->getAttribute((isset($context["noticia"]) ? $context["noticia"] : $this->getContext($context, "noticia")), "id"), "html", null, true);
                echo "\" src=\"";
...
\t\t\t\t\t\t\t";
                ...
                echo twig_escape_filter($this->env, twig_date_format_filter($this->env, $this->getAttribute((isset($context["noticia"]) ? $context["noticia"] : $this->getContext($context, "noticia")), "dataEntrada"), "Y F jS"), "html", null, true);
                echo "
\t\t\t\t\t\t</div>
\t\t\t\t\t
\t\t\t\t\t</div>
...
";
    ...
    {
        return "AcmeStoreBundle:llibreria:Noticia.html.twig";
    }
