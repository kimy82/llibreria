...
/* AcmeStoreBundle:presentacio:PresentacioList.html.twig */
class __TwigTemplate_9243ed2abea4a61a9410f2222c44b735 extends Twig_Template
{
    ...
    <h1 class=\"title\">Noticia  ";
        // line 10
        echo $this->env->getExtension('translator')->getTranslator()->trans("presentacio_list_page", array(), "messages");
        echo "</h1>
    \t<a href=\"";
        // line 11
    ...
    \t<a href=\"";
        // line 12
        echo $this->env->getExtension('routing')->getPath("acme_pre_store_presentacio", array());
        echo "\" >";
        echo $this->env->getExtension('translator')->getTranslator()->trans("enter_presentacio", array(), "messages");
        echo "</a>
    \t";
        // line 13
    ...
    \t\t";
            ...
            foreach ($context['_seq'] as $context["_key"] => $context["presentacio"]) {
                ...
                echo "\" /> \t<a href=\"";
                echo twig_escape_filter($this->env, $this->env->getExtension('routing')->getPath("edit_presentacio", array("id" => $this->getAttribute((isset($context["presentacio"]) ? $context["presentacio"] : $this->getContext($context, "presentacio")), "id"))), "html", null, true);
                echo "\" >";
                echo $this->env->getExtension('translator')->getTranslator()->trans("edit_presentacio", array(), "messages");
                echo "</a> <a href=\"";
                echo twig_escape_filter($this->env, $this->env->getExtension('routing')->getPath("delete_presentacio", array("id" => $this->getAttribute((isset($context["presentacio"]) ? $context["presentacio"] : $this->getContext($context, "presentacio")), "id"))), "html", null, true);
                echo "\" >";
                echo $this->env->getExtension('translator')->getTranslator()->trans("delete_presentacio", array(), "messages");
                echo "</a></li> 
    \t\t";
            }
...
";
    ...
    {
        return "AcmeStoreBundle:presentacio:PresentacioList.html.twig";
    }
