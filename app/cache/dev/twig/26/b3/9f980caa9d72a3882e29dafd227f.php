...
/* AcmeStoreBundle:suggerencia:SuggerenciaMain.html.twig */
class __TwigTemplate_26b39f980caa9d72a3882e29dafd227f extends Twig_Template
{
    ...
    <h1 class=\"title\">";
        // line 10
        echo $this->env->getExtension('translator')->getTranslator()->trans("menu_admin_suggerencia", array(), "messages");
        echo "</h1>
    ...
    \t<div class=\"inline_menun_interior\" ><a href=\"";
        ...
        echo "\" >";
        echo $this->env->getExtension('translator')->getTranslator()->trans("enter_suggerencia", array(), "messages");
        echo "</a></div>
    \t<div class=\"inline_menun_interior\" ><a href=\"";
        // line 13
        echo $this->env->getExtension('routing')->getPath("llistat_store_suggerencia", array("orderBy" => "1=1 order by n.id asc"));
        echo "\" >";
        echo $this->env->getExtension('translator')->getTranslator()->trans("suggerencia_list_page", array(), "messages");
        echo "</a></div>
...
";
    ...
    {
        return "AcmeStoreBundle:suggerencia:SuggerenciaMain.html.twig";
    }
